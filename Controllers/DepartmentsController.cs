...
namespace ContosoUniversity.Controllers
{
    public class DepartmentsController : Controller
    {
        ...
        public DepartmentsController(FokonContext context)
        {
            _context = context;
        }
        ...
        {
            var fokonContext = _context.Departments.Include(d => d.Administrator);
            return View(await fokonContext.ToListAsync());
        }
        ...
        public async Task<IActionResult> Delete(Department department)
        {
            ...
            {
                return RedirectToAction(nameof(Delete), new { conccurencyError = true, id = department.DepartmentID });
            }
        }
